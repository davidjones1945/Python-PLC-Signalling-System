            ...
            if data is not None:
                ...
                if data['Cesta']['stavanie']:
                    ...
                    data['Cesta']['odosielatel'] != 'RAD'):
                        ...
                        self.app_instance.zoznamNav[self.app_instance.Start].pociatocne = True
                ...
                if data['Cesta']['rusenie']:
                    if data['Cesta']['koncove'] in self.app_instance.zoznamNav.keys() and data['Cesta']['odosielatel'] != 'RAD':
                        self.app_instance.End = data['Cesta']['koncove']
                        self.app_instance.szz.rusenieCesty(server=True)
                        self.app_instance.prikazDoPLC(cesta=True)

                if data['Navest']['ID'] != 0 and data['Navest']['ID'] in self.app_instance.zoznamNav.keys() and data['Navest']['odosielatel'] != 'HLO':
