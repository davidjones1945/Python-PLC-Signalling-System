...
class DataUpdate(QThread):
    ...
    def __init__(self, app_instance):
        self.dictUseky ={   #slovník úsekov
            ...
            12: Vyhybka(ID=2, IDsmer=4, nazovGUI='ZBE_V1', usek='ZBE_v1', spojka=True, enumIkon=ico.SpojkaA, dictIkon=ico.dictSpojkaA, zavisla=40, druhaVymena=13, app=app_instance),
            13: Vyhybka(ID=3, IDsmer=5, nazovGUI='ZBE_V2', usek='ZBE_v2', spojka=True, enumIkon=ico.SpojkaB, dictIkon=ico.dictSpojkaB, zavisla=41, druhaVymena=12, app=app_instance),
            ...
            40: Vyhybka(ID=2, IDsmer=4, nazovGUI='DISP_ZBE_V1', usek='DISP_ZBE_v1', spojka=True, enumIkon=ico.SpojkaA, dictIkon=ico.dictSpojkaA, zavisla=12, druhaVymena=41, app=app_instance),
            41: Vyhybka(ID=3, IDsmer=5, nazovGUI='DISP_ZBE_V2', usek='DISP_ZBE_v2', spojka=True, enumIkon=ico.SpojkaB, dictIkon=ico.dictSpojkaB, zavisla=13, druhaVymena=40, app=app_instance),
